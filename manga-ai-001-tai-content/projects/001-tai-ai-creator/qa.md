...
- [x] `comic-pages/page-01.png` through `page-08.png` render as panelled manga pages.
- [x] `viewer/index.html` embeds the manga pages directly instead of showing only navigation cards.
...
- 2026-07-03: Reworked the deliverable from a one-illustration-per-page preview into rendered manga pages with panel borders, speech balloons, captions, and direct viewer embedding.
...
- `node scripts/manga-render-comic-pages.mjs 001-tai-ai-creator`: PASS, 8 rendered comic page PNGs.
